...
template <equality_comparable T>    //// Use the predefined std::equality_comparable concept.
...
template <equality_comparable T, size_t N>    //// Use the predefined std::equality_comparable concept.
